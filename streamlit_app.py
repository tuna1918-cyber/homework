...
# Page 10 '연결손익계산서' 기반 분기별 영업이익 데이터
op_profit_data = {
...
with tab1:
    st.markdown("""
    **Streaming Highlights (Page 5)**
    
    2025년 상반기 빌보드 Hot 100 성과:
    * **BTS**:
        * 지민, 'Who', 11주 연속 차트인
        * 제이홉, 'LV Bag', 'Sweet Dreams', 'Mona Lisa' 각각 차트인
        * 진, 'Don't Say You Love Me' 차트인
    * **Quality Control Music**:
        * Lil Baby, 상반기 총 13곡 차트인
        * BigXthaPlug, 'The Largest' 18주, 'All The Way' 12주 차트인
    * **Big Machine Label Group**:
        * Riley Green, 'Worst Way', 21주 연속 차트인
        * Thomas Rhett, 'Somethin' Bout a Woman' 6주, 'After All The Bars Are Closed' 9주 연속 차트인
    """)

with tab2:
    st.markdown("**Concert Highlights (Page 6)**")
...
with tab3:
    st.markdown("""
    **KATSEYE Highlights (Page 7)**
    
    * 두 번째 미니앨범 'Beautiful Chaos' 'Billboard 200' 등 4주 연속 차트인
    * 선공개곡 'Gnarly' 'Billboard Hot 100' 3주, 'Global 200' 12주 연속 차트인
    * 수록곡 'Gabriela' 'Billboard Hot 100' 2주, 'Global 200' 등 5주 연속 차트인
    * 데뷔 1년 반만에 첫 투어 'The Beautiful Chaos Tour' 발표, 13개 도시 및 추가 3개 공연 전석 매진
    """)
...
st.markdown("""
'유동 현금 흐름' 요청에 따라, PDF '요약재무제표'의 **'유동자산'** 항목을 기반으로 유동성을 분석합니다.
""")
